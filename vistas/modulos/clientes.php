  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-header with-border">
        ...
        <button class="btn btn-naranja" data-toggle="modal" data-target="#modalAgregarCliente">
          Agregar Cliente 
        </button>
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                  ...
                  <div class="input-group">
                      ...
                      <input type="number" min="0" class="form-control input-lg" name="nuevaIdentidad" placeholder="Ingresar identidad" required>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-naranja">Guardar cliente</button>
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                  ...
                  <div class="input-group">
                      ...
                      <span class="input-group-addon"><i class="fa fa-key"></i></span> 
                      <input type="number" min="0" class="form-control input-lg" id="editarIdentidad" name="editarIdentidad" required>
